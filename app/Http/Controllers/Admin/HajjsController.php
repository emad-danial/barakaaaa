...
class HajjsController extends Controller
{
     ...
     * @return void
     */
    public function index(HajjDatatable $admin)
    {
        //
        return $admin->render('admin.hajjs.index');
    }
...
//        dd($include);
        return view('admin.hajjs.create', compact('include'));
    }
   ...
   public function edit($id)
    {
        ...
        return view('admin.hajjs.edit', compact('model', 'include', 'umarhDetails', 'umrahHaagIncludes', 'umarhDays', 'umarhPricies', 'umarhGallery', 'umarhStopOver'));
    }
