...
class UmrahDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('edit', 'admin.umrahs.btn.edit')
            ->addColumn('delete', 'admin.umrahs.btn.delete')
            ->rawColumns([
                'edit',
                'delete',
            ]);
    ...
    {
        return Umrah::query()->where('package_type','umar');
    }
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons'    =>[
                    [
                        'text' => '<i class="fa fa-plus"></i> '. 'Create Umrah',
