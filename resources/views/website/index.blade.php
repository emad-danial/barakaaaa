...
<!--                    <center><img src= "{{Request::root()}}/website/images/partner.png" />-->
<!--                    <img src= "{{Request::root()}}/website/images/partner.png" />-->
<!--                    <img src= "{{Request::root()}}/website/images/partner.png" />-->
<!--                    <img src= "{{Request::root()}}/website/images/partner.png" />-->
<!--                    <img src= "{{Request::root()}}/website/images/partner.png" /></center>-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
...
<div id="myCarousel1" class="carousel carousel-fade" data-ride="carousel" data-interval="2000">
    ...
    <div class="carousel-inner carousel-inner1" role="listbox">
        @foreach($getBackground as $key)
        <div class="item @if($loop->index ==1) active @endif">
            <img src="{{Request::root()}}/{{$key->image}}" alt="Chania" class="slider-img">
            <!--<div class="CoverPhoto">-->
            <!--    <h1 class="block-title block-title-bold">{{$appSetting->cover_title}}</h1>-->
            <!--    <div class="PositionCaption">-->
            <!--        <p class="editepc">{{$appSetting->cover_description}}</p>-->
            <!--    </div>-->
            <!--</div>-->
        </div>
        @endforeach
...
@foreach($getLogo as $key)
            <div class=" item imgedite text-center">
                <img src="{{Request::root()}}/{{$key->image}}" alt="img">
            </div>
            @endforeach
</div>
    ...
    <div class="rows pad-bot-redu tb-space pb-0">
        <div class="container">
            ...
            <div class="carousel-box owl-carousel owl-theme">
                @foreach($getTopUmar as $umarh)
                <!-- TOUR PLACE 1 -->
                <div class="b_packages wow fadeInUp">
                    <!-- OFFER BRAND -->
                    @if($umarh['umar']['is_offer'] !=NULL)
                    ...
                    <div class="v_place_img">
                        @if($umarh['umarImages'] != null && count($umarh['umarImages'])>0)       
                        <a href="/umrah-package-details/{{$umarh['umar']['id']}}/{{$umarh['umar']['name']}}">
                            <img width="350" height="223" src="{{$umarh['umarImages'][0]}}" alt="Tour Booking"
                            ...
                            <div class="to-ho-hotel-con-3">
                                <ul class="hotels-list">
                                    ...
                                    <li style="width: 30%;"> <span class="ho-hot-pri"
                                            style="font-size:20px;">${{$umarh["umar"]['minPrice']}} </span> </li>
                                    <!--<li style="width: 100%; padding-top: 0px;">                                          -->
                                    <!--     {{$umarh['umar']['toCity']}}  from {{$umarh['umar']['fromCity']}}-->
        ...
        <div class="container">
            ...
            <div class="carousel-box owl-carousel owl-theme">
                ...
                <div class="b_packages wow fadeInUp" data-wow-duration="0.7s">
                    ...
                    <!-- IMAGE -->
                    <div class="v_place_img">
                         @if($key['umarImages'] != null && count($key['umarImages'])>0)     
                        <a href="/umrah-package-details/{{$key['umar']['id']}}/{{$umarh['umar']['name']}}">
                            <img src="{{$key['umarImages'][0]}}" alt="Tour Booking" title="Tour Booking" width="350"
                                height="223" /> </a> 
                                 @endif 
                                </div>
                    <!-- TOUR TITLE & ICONS -->
                    <div class="b_pack rows">
                        ...
                        <div class="to-ho-hotel-con-23">
                            ...
                            <div class="to-ho-hotel-con-3">
                                <ul class="hotels-list">
                                    <li style="width: 70%;">
                                        {{$key['umar']['startDateInformat']}}
                                        to
                                        {{$key['umar']['endDateInformat']}}

                                    </li>
                                    <li style="width: 30%;"> <span class="ho-hot-pri"
                                            style="font-size:20px;">${{$key['umar']['minPrice']}} </span> </li>
                                    <!--<li style="width: 100%; padding-top: 0px;">      -->

                                    <!--{{$key['umar']['toCity']}}  from {{$key['umar']['fromCity']}}-->
...
<section>
    <div class="rows tb-space pad-bot-redu">
        <div class="container">
            ...
            <!-- HOTEL GRID -->        
            <div class="carousel-box owl-carousel owl-theme">
            @foreach($getTopHotels as $key)
                <!-- HOTEL GRID -->
                    <div class="to-ho-hotel-con">
                        <a href="/hotels/{{$key['id']}}/{{$key['name']}}">
                            <div class="to-ho-hotel-con-1">
                                <div class="hot-page2-hli-3"></div>
                                <div class="hom-hot-av-tic"> Available Rooms: {{$key['availbleTickets']}} </div>
   @if($key['hotelImages'] != null && count($key['hotelImages'])>0)  
                                <img width="350" height="223" src="{{$key['hotelImages'][0]}}" alt="">
                                @endif
                            </div>
                        </a>
                        <div class="to-ho-hotel-con-23">
                                ...
                                <ul class="hotels-list">
                                    <li>
                                        <p class="details-desc">
                                            City: {{$key['address']}},{{$key['city']}}
                                        </p>
                                        <div class="dir-rat-star ho-hot-rat-star"> Rating:
                                            @for($i= 1;$i<=5;$i++) @if($i <=$key['rate']) <i class="fa fa-star"></i>
                                                @elseif(($i-$key['rate'] > 0) && ($i-$key['rate'] < 1)) <i
                                    ...
                                    <li><span class="ho-hot-pri">${{$key['minPrice']}}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <div class="rows pla pad-bot-redu tb-space">
        <div class="container">
            ...
            <div class="spe-title spe-title-1">
                ...
                <p>{{$appSetting->home_top_stopOver}}</p>
            </div>
            <div class="popu-places-home owl-carousel owl-theme" >
                <!-- POPULAR PLACES 1 -->
                @foreach($getStopOver as $key)
                <div class="">
                    <div class="place">
                        <div class="row">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                             @if($key['umarImages'] != null && count($key['umarImages'])>0)  
                        <a href="/umrah-package-details/{{$key['umar']['id']}}/{{$umarh['umar']['name']}}">
                            <img src="{{$key['umarImages'][0]}}" alt="" width="248px;" height="222px;" /> </a>
                            @endif
                            </div>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <h3><span>{{$key['umar']['name']}}</span> Duration : {{$key['umar']['duration']}} Days</h3>
                        <p></p> <a href="/umrah-package-details/{{$key['umar']['id']}}/{{$umarh['umar']['name']}}"
    ...
    <div class="rows tb-space">
        <div class="container events events-1" id="inner-page-title">
            ...
            <table id="myTable">
                ...
                <tbody>
                    @foreach($getTopVisit as $key)
                    <tr>
                        <td>{{$loop->index+1}}</td>
                        <td class="">
                            <a class="disableHover"
                                href="/umrah-package-details/{{$key['umar']['id']}}/{{$umarh['umar']['name']}}">
                                 @if($key['umarImages'] != null && count($key['umarImages'])>0)  
                                <img src="{{$key['umarImages'][0]}}" alt="" width="90" height="60" />
                                @endif
                            </a>
                        </td>
                        <td class="title">
                            <a href="/umrah-package-details/{{$key['umar']['id']}}/{{$umarh['umar']['name']}}"
                                class="events-title">{{$key['umar']['name']}}</a>
                        </td>
                        <td class="e_h1">{{$key['umar']['startDate'] }}</td>
                        <!--<td class="e_h1">{!! $key['umar']['fromCity'] !!}</td>-->
                        <td><a href="/umrah-package-details/{{$key['umar']['id']}}/{{$umarh['umar']['name']}}"
...
<section>
    <div class="foot-mob-sec tb-space">
        <div class="rows container">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 family"><img src="{{Request::root()}}/website/images/mobile.png"
                    alt="" /></div>
            <!-- REQUEST A QUOTE -->
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="foot-mob-app">
                    ...
                    <a href="https://play.google.com/store/apps/details?id=com.barkatravel.usbarakatravelapp"><img
                            src="{{Request::root()}}/website/images/android.png" alt="Android" class="android" /></a>
                    <a href="https://apps.apple.com/eg/app/baraka-travel-app/id1557149169"><img
                            src="{{Request::root()}}/website/images/apple.png" alt="IOS" class="ios" /></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="rows tips tips-home tb-space home_title">
        <div class="container tips_1">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="row">
                    <h3>{{$appSetting->UMARH_UPDATE_INFORMATION_TITLE}}</h3>
                    <h3>Customer Testimonials</h3>
                </div>


                <div class="tips_left tips_left_1">
                    {!! $appSetting->UMARH_UPDATE_INFORMATION_DESCRIPTION !!}
                </div>
            ...
            @foreach($getTopRate as $key)
            <div class="col-md-8 col-sm-6 col-xs-12 testi-2">
                <div class="testi" style="background:url( {{Request::root()}}/{{\App\User::find($key->user_id)->image}} )
