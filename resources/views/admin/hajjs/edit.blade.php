...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
                ...
                <div>
                    {!! Form::model($model, [
                    'action' => ['Admin\HajjsController@update',$model->id],
                    'method' =>'put',
                    'files' =>true,
                    ]) !!}
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        {!! Form::number('is_offer', null , ['class' => 'form-control', 'placeholder' => 'Enter Hajj
                        Offer If Exist']) !!}
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <textarea id="editorrituals" name="rituals">{{$model->rituals}}</textarea>
                    </div>
                    ...
                    @endpush
                    <div class="form-group col-lg-6">
                        <label for="flighting">Flight </label>
                        <textarea id="editorflighting" name="flighting">{{$model->flighting}}</textarea>
                    </div>
                    ...
                    <div class=" col-lg-6">
                        <label for="gender" style="margin-top: 20px" class="">Hajj Type</label>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" style="display: inline">
