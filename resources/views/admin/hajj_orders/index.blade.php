    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                {{--<a class="btn btn-primary" href="{{url(route('hajj_orders.create'))}}"><i class="fa fa-plus"></i> New Hotels Amenitie</a>--}}
            </div>
            <div class="box-body">
                @if(count($records))
                                                        ...
                                                        <div id="del_hajj_orders{{ $record->id }}" class="modal fade" role="dialog">
                                                            <div class="modal-dialog">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{route('hajj_orders.destroy',$record->id)  }}" method="POST">
                                                                        @method('DELETE')
                                                                        @csrf
