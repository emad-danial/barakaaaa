    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Slider & Logos </h3>
                <a class="btn btn-primary" href="{{url(route('app_gallery.create'))}}"><i class="fa fa-plus"></i> New Slider & Logos </a>
            </div>
            <div class="box-body">
                @if(count($records))
                <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                                ...
                                                @foreach($records as $record)
                                                    <tr id="removable{{$record->id}}">
                                                        ...
                                                        <td class=" text-center">
                                                            <a class="btn btn-primary" href="{{ route('app_gallery.edit',$record->id) }}" role="button"><i class="fa fa-edit"></i></a>
                                                        </td>
                                                        <td class="text-center">
                            ...
                            <form action="{{route('app_gallery.destroy',$record->id)  }}" method="POST">
                                @method('DELETE')
                                @csrf
