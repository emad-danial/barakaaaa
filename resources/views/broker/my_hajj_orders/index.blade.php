                                                    ...
                                                    <tr id="removable{{$record->id}}">
                                                      ...
                                                      <td> $ {{$record->price}}</td>
                                                        ...
                                                        <td class=" text-center">
                                                            <a class="btn btn-primary" href="{{ route('my_hajj_orders.show',$record->id) }}" role="button"><i class="fa fa-eye"></i></a>
                                                        </td>
                                                    <td class=" text-center">
                                                            <a class="btn btn-primary" href="{{ route('my_hajj_orders.edit',$record->id) }}" role="button"><i class="fa fa-edit"></i></a>
                                                    </td>
                                                    
                                                       <td class=" text-center">
                                                          
                                                           <a class="btn btn-primary" href="{{ url('broker/my_hajj_orders/add/'.$record->id) }}" role="button"><i class="fa fa-plus"></i></a>
                                                       </td>
                                                        <td class="text-center">
...
<form action="{{route('my_hajj_orders.destroy',$record->id)  }}" method="POST">
                                                                        @method('DELETE')
                                                                        @csrf
